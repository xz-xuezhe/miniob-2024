...
create_vector_index_stmt:
    CREATE VECTOR_T INDEX ID ON ID LBRACE ID RBRACE WITH LBRACE ID EQ ID COMMA ID EQ L2_DISTANCE COMMA ID EQ NUMBER COMMA ID EQ NUMBER RBRACE
    {
      $$ = new ParsedSqlNode(SCF_CREATE_VECTOR_INDEX);
    };
    | CREATE VECTOR_T INDEX ID ON ID LBRACE ID RBRACE WITH LBRACE ID EQ ID COMMA ID EQ COSINE_DISTANCE COMMA ID EQ NUMBER COMMA ID EQ NUMBER RBRACE
    {
      $$ = new ParsedSqlNode(SCF_CREATE_VECTOR_INDEX);
    };
    | CREATE VECTOR_T INDEX ID ON ID LBRACE ID RBRACE WITH LBRACE ID EQ ID COMMA ID EQ INNER_PRODUCT COMMA ID EQ NUMBER COMMA ID EQ NUMBER RBRACE
    {
      $$ = new ParsedSqlNode(SCF_CREATE_VECTOR_INDEX);
    };
